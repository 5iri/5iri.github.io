...
parent: Blog
permalink: blog/cxls-are-important
date: 2025-12-15
tags:
...
<figure class="diagram" style="text-align: center;">
  <img src="{{ '/markdown_files/posts/assets/cxl-protocol-stack-dark.svg' | relative_url }}" alt="Layered view of PCIe physical layer with CXL.io, CXL.cache, and CXL.mem" style="max-width: 100%; height: auto; margin: 0 auto; display: block;" />
...
<figure class="diagram" style="text-align: center;">
  <img src="{{ '/markdown_files/posts/assets/memory-tiering-heatmap-dark.svg' | relative_url }}" alt="HBM, local DDR5, and CXL memory tiers with latency annotations" style="max-width: 100%; height: auto; margin: 0 auto; display: block;" />
...
<figure class="diagram" style="text-align: center;">
  <img src="{{ '/markdown_files/posts/assets/cxl-coherence-flow-dark.svg' | relative_url }}" alt="CPU cache and accelerator cache exchanging snoop requests via CXL" style="max-width: 100%; height: auto; margin: 0 auto; display: block;" />
...
<figure class="diagram" style="text-align: center;">
  <img src="{{ '/markdown_files/posts/assets/cxl-pooled-topology-dark.svg' | relative_url }}" alt="CXL switch connecting multiple hosts to memory sleds" style="max-width: 100%; height: auto; margin: 0 auto; display: block;" />
...
<figure class="diagram" style="text-align: center;">
  <img src="{{ '/markdown_files/posts/assets/cxl-latency-bandwidth-dark.svg' | relative_url }}" alt="Latency bars and bandwidth line for HBM, DDR5, CXL, NVMe, and network storage" style="max-width: 100%; height: auto; margin: 0 auto; display: block;" />
...
<figure class="diagram" style="text-align: center;">
  <img src="{{ '/markdown_files/posts/assets/cxl-ras-dark.svg' | relative_url }}" alt="CXL fabric protected by ECC, poison handling, and IDE encryption" style="max-width: 100%; height: auto; margin: 0 auto; display: block;" />
...
<figure class="diagram" style="text-align: center;">
  <img src="{{ '/markdown_files/posts/assets/cxl-software-flow-dark.svg' | relative_url }}" alt="Software stack from BIOS to Linux CXL drivers to frameworks" style="max-width: 100%; height: auto; margin: 0 auto; display: block;" />
...
<figure class="diagram" style="text-align: center;">
  <img src="{{ '/markdown_files/posts/assets/cxl-ai-workflows-dark.svg' | relative_url }}" alt="GPU nodes drawing KV caches, optimizer states, and MoE experts from a shared CXL memory pool" style="max-width: 100%; height: auto; margin: 0 auto; display: block;" />
